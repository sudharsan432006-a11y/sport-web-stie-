    ...
    <div className="w-screen">
      ...
      <Section align="right">
        ...
        <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
            ...
            />
            <button type="submit" className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-full font-bold hover:opacity-90 transition-opacity">
                Secure Access
            </button>
        </form>
      </Section>
